  ...
  <div class="card h-full flex flex-col">
    ...
    <div v-if="myInfo" class="flex flex-col gap-4 flex-1">
      <div class="text-xl mb-5 text-gray-500">
        기관담당자 <br />
        <span class="text-2xl font-bold text-black">{{ myInfo.name }} 님</span>
      </div>
      ...
      <table class="w-full border-collapse">
        <tbody>
          ...
          <tr>
            <td class="text-left text-lg py-2 font-medium border-b border-gray-300">
              {{ myInfo.id }}
            </td>
          </tr>
          ...
          <tr>
            <td class="text-left text-lg py-2 font-medium">
    ...
    <!-- 수정 모달 -->
    <MyInfoEditModal v-if="myInfo" :modalValue="editOpen" :myInfo="myInfo" :userType="myInfo.type" @update:modalValue="editOpen = $event" @save="handleSave" />
