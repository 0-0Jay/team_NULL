      ...
      <Tabs :value="activeTab">
        ...
        <TabPanels>
          <TabPanel v-for="(secValue, sec_no) in data" :value="sec_no">
            <DataTable :value="makeTableRows(secValue, sec_no)" rowGroupMode="subheader" groupRowsBy="detail" sortMode="single" sortField="detail" :sortOrder="1" scrollable scrollHeight="670px" tableStyle="min-width: 50rem">
